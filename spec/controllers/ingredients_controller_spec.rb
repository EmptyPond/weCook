...
RSpec.describe IngredientsController, type: :controller do
  ...
  describe "ingredients#edit" do
    it "should let me access the edit page if I am logged in and own the kitchen" do
      ingredient = FactoryGirl.create(:ingredient)
      login_user(ingredient.kitchen.user.last)
      get :edit, params: {id: ingredient.id,kitchen_id: ingredient.kitchen.id }
  ...
  describe "ingredients#update" do
    it "should let me update the ingredients" do
      ingredient = FactoryGirl.create(:ingredient)
      login_user(ingredient.kitchen.user.last)
      post :update, params: {id: ingredient.id, kitchen_id: ingredient.kitchen.id, ingredient: {name: "new stuff", amount: "tons" } }
